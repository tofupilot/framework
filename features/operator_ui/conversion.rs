...
fn convert_ui_component(proc_comp: &ProcedureUIComponent) -> UiComponent {
    let component_type = match &proc_comp.component_type {
        ...
        crate::procedure::schema::UIComponentType::Dropdown => ComponentType::Dropdown,
        crate::procedure::schema::UIComponentType::Multidropdown => ComponentType::Multidropdown,
