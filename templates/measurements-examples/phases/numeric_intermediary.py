...
def test_intermediary_numeric(phase, test_api, ui):
    ...
    test_api.measurements.voltage_with_metadata = voltage
    test_api.log.info(f"Voltage with metadata: {voltage:.4f}V")
