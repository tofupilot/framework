...
def test_auto_evaluate(phase, test_api, ui):
    ...
    test_api.measurements.auto_evaluate_test = voltage
    test_api.log.info(f"Auto-evaluate test voltage: {voltage}V (will be auto-evaluated against >= 3.0)")
